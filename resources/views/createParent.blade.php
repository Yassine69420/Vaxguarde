            ...
            <div class="col-lg border-right row3 ">
                <div class="p-2 py-3">
                    ...
                    <div class="row mt-2 mrg m-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="adress" class="form-control"
                                placeholder="Ait ati 2 for exemple" />
                        </div>
                        <div class="col-md-6">
                            <label class="labels">telephone</label>
                            <input type="text" name="telephone" class="form-control"
                                placeholder="0657263527 for exemple" />
                        </div>
                    </div>
                    ...
                    <div class="row mt-2 mrg m-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="Email" class="form-control"
                                placeholder="vaxguarde420@gmail.com comme exemple" />
                        </div>
                        <div class="col-md-6">
                            <label class="labels">Ville</label>
                            <input type="text" class="form-control" name="Ville"
                                placeholder="Errachidia comme example">
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between  m-3   ">
                        ...
                        <button type="submit "  class="btn btn-outline-primary pl-4 pr-4 mr-2">Next</button>
                    </div>
